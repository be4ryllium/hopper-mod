...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        addRecipe(new ItemStack(Block.hopper, 1), new Object[] {
            "# #", "#X#", " # ", Character.valueOf('#'), Block.stone, Character.valueOf('X'), Block.chest
        });
        addRecipe(new ItemStack(Block.torchRedstoneActive, 1), new Object[] {
            "#", Character.valueOf('#'), Block.dirt
        });
        addRecipe(new ItemStack(Block.pressurePlateStone, 1), new Object[] {
            "#", Character.valueOf('#'), Block.torchRedstoneActive
        });
        addRecipe(new ItemStack(Item.redstone, 1), new Object[] {
            "#", Character.valueOf('#'), Block.pressurePlateStone
        });
        addRecipe(new ItemStack(Block.dispenser, 1), new Object[] {
            "#", "#", Character.valueOf('#'), Block.dirt
        });
        addRecipe(new ItemStack(Item.ingotIron, 64), new Object[] {
            "# ", " #", Character.valueOf('#'), Block.dirt
        });
        addRecipe(new ItemStack(Item.bed, 1), new Object[] {
            "#", Character.valueOf('#'), Block.cloth
        });
        addRecipe(new ItemStack(Block.hopper, 64), new Object[] {
            "##", Character.valueOf('#'), Block.dirt
        });
