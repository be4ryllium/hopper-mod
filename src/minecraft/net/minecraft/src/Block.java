...
public class Block
{
    ...
    static 
    {
        ...
        hopper = (new BlockHopper(97, 65)).setHardness(1F).setResistance(10F).setStepSound(soundMetalFootstep).setBlockName("hopper").disableNeighborNotifyOnMetadataChange();
