    ...
    implements IInventory
{
    ...
    public void doNothingWithTheStack() {
        drop_stack_number = -1;
    }

    public void setTheStackTo(ItemStack item_to_be_set) {
        if (drop_stack_number != -1) {
            setInventorySlotContents(drop_stack_number, item_to_be_set);
            drop_stack_number = -1;
        }
    }

    public void decrTheStack() {
        if (drop_stack_number != -1) {
            decrStackSize(drop_stack_number, 1);
            drop_stack_number = -1;
        }
    }
